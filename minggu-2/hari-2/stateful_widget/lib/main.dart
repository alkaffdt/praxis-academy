...
class AwesomeButtonState extends State<AwesomeButton>{
  int counter = 0;
  List<String> strings = ["Flutter", "is", "Maknyusss"];
  String displayedString = "";

  //you can also declare variable koyok ngene
  //var counter = 0;
  //var string= ["Flutter", "is", "maknyuss"];
  ...
  Widget build(BuildContext context){
    return new Scaffold(
      appBar: new AppBar(title: new Text("Ini Stateful Widget"), backgroundColor: Colors.deepOrange,),
      body: new Container(
        child: new Center(
          child: new Column(
